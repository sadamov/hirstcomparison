...
data <- map(data, ~.x %>% replace(is.na(.), 0)) # Current solution to remove all NAs from dataset
...
# resolution = c("daily", "12hour", "6hour", "3hour", "hourly")
# group = c("line", "trap")
# traps = c(2, 4, 6)

plot_pollen(species = "Poaceae", resolution = "6hour", group = "line", traps = 2)
