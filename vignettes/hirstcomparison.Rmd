...
### Pairwise Wilcox, Dunn's test, the Conover-Iman test, and the Dwass-Steel-Crichtlow-Fligner

```{r}

dunn.test::dunn.test(data_anova %>% pull(!!sym(species)),
                     data_anova$trap,
                     method = "holm")

conover.test::conover.test(data_anova %>% pull(!!sym(species)),
                     data_anova$trap,
                     method = "holm")
