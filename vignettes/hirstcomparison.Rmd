...
data[[1]] %>% Amelia::missmap(y.labels = "", y.at = 1, col = ggthemr::swatch()[c(4,2)])
...
plot <- plot_pollen(species = "Alnus", resolution = "6hour", group = "trap", traps = c(2, 4, 8), rm_zeros = TRUE)
plot
...
distinguish adequately between ﬁxed and proportional bias. Least products regression analysis, although more difﬁcult to
...
correlation coefﬁcient (r) is valueless as a test for bias.
