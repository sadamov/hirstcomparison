...
for (j in c("Fraxinus", "Poaceae", "Betula", "Quercus", "Pinus", "Cupressus")){
  gg_hist_species[[j]] <- plot_hist_dt(data_errors, j, n_test = 1, samples = 1, plots = TRUE, tdist = FALSE)
}
...
for (j in c("Group1", "Group2", "Group3", "Group4", "Group5", "Total")){
  gg_hist_groups[[j]] <- plot_hist_dt(data_errors, species = j, n_test = 1, samples = 1, plots = TRUE, tdist = FALSE)
}
...
for (j in c("Group00_10", "Group10_20", "Group20_50", "Group50_100", "Group100_500", "Group500")){
  gg_hist_conc[[j]] <- plot_hist_dt(data_errors_conc, j, n_test = 1, samples = 1, plots = TRUE, tdist = FALSE)
}
...
ggsave("figure1_timeseries_boxplot_hist.png", gg_comparison, width = 9, height = 6, dpi = 300)
ggsave("figure2_timeseries.png", gg_timeseries, width = 9, height = 6, dpi = 300)
ggsave("figure3_correlation.png", gg_corr, width = 12, height = 8, dpi = 300)
ggsave("figure4_altman_bland.png", gg_ab, width = 12, height = 8, dpi = 300)

#### PER TEMPORAL AVERAGE
ggsave("figure5_error_hist_species.png", gg_error_species, width = 12, height = 8, dpi = 300)
ggsave("figure6_error_hist_size.png", gg_error_size, width = 12, height = 8, dpi = 300)
ggsave("figure7_error_hist_conc.png", gg_error_conc, width = 12, height = 8, dpi = 300)
ggsave("figure8_measurement_differences_conc_groups.png", gg_dens_conc, width = 12, height = 8, dpi = 300)
```
