...
species <- "total" # Total is the only option currently, as poleno classifier is not yet functional c("total", "alnus", "corylus", "taxus", "ulmus", "cupressus" "betula",  "populus", "poaceae", "fraxinus"  "platanus"  "quercus", "fagus", "pinaceae", "carpinus")
...
# save(data_raw_poleno, file = "data_raw_poleno.Rdata")
